...
FORM alv_display.
  ...
  lo_alv_grid->set_table_for_first_display(
    EXPORTING
      ...
      it_toolbar_excluding          = VALUE #( ( cl_gui_alv_grid=>mc_fc_f4 )      ( cl_gui_alv_grid=>mc_fc_minimum )    ( cl_gui_alv_grid=>mc_fc_view_lotus )
                                               ...
                                               ( cl_gui_alv_grid=>mc_fc_help )    ( cl_gui_alv_grid=>mc_fc_call_xxl )   ( cl_gui_alv_grid=>mc_fc_call_crbatch )
                                               ( cl_gui_alv_grid=>mc_fc_html )    ( cl_gui_alv_grid=>mc_fc_excl_all )   ( cl_gui_alv_grid=>mc_fc_col_optimize )
                                               ...
                                               ( cl_gui_alv_grid=>mc_mb_export )  ( cl_gui_alv_grid=>mc_fc_expcrtempl ) ( cl_gui_alv_grid=>mc_fc_current_variant )
