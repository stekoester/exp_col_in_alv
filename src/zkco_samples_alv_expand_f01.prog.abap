FORM data_get.
  DATA ls_tadir_output TYPE zkco_samples_alv_tadir_output.
  DATA ls_tadir TYPE zkco_samples_alv_tadir.
  DATA ls_cell_type TYPE lvc_s_styl.
...
FORM alv_display.
  ...
  FIELD-SYMBOLS <ls_fieldcatalog> TYPE lvc_s_fcat.
